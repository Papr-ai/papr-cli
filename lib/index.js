...
const { isHolidaySeason, getHolidayLogo, getRegularLogo } = require('./holiday-theme');
...
async function initPapr(options = {}) {
  ...
  try {
    ...
    console.log('\\n');
    // Display holiday or regular logo based on season
    const logo = isHolidaySeason() ? getHolidayLogo() : getRegularLogo();
